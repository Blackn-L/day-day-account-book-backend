...
module.exports = (app) => {
  ...
  router.get("/api/user/get", _jwt, controller.user.get_user_info); // 获取用户信息
  router.post("/api/user/edit", _jwt, controller.user.edit); // 编辑用户信息
  ...
  router.get("/api/bill/delete", _jwt, controller.bill.delete); // 删除账单
  router.get("/api/bill/date", _jwt, controller.bill.date); // 获取整月账单统计数据
};
